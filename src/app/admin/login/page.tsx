...
// Mengimpor file CSS utama dengan jalur yang benar (naik 3 tingkat)
import "../../globals.css"; 
...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative z-0 selection:bg-blue-100 selection:text-blue-900 bg-slate-50">
      <div
        aria-hidden="true"
